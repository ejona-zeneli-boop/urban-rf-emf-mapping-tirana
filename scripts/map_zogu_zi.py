...
INPUT_FILE = PROJECT_DIR / "data" / "zogu_zi_anonymized.xlsx"
OUTPUT_DIR = PROJECT_DIR / "outputs" / "figures" / "zogu_zi"
...
df = df.rename(columns={"lat_round": "lat", "long_round": "lon"})
...
for band in bands:
    ...
    # SAVE
    # --------------------------------------------------------
    output_file = OUTPUT_DIR / f"{band}.png"
