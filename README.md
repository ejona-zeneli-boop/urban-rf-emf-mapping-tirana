...
For an offline validation without satellite tiles, run:
...
The Esri World Imagery basemap is fetched by `contextily`; imagery and
attribution remain subject to the provider's terms.
